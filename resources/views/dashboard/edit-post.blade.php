<x-dashboard.layouts.app>
    ...
    <form action="{{ route('dashboard.posts.update', $post) }}" method="post" class="flex flex-col space-y-4">
        @csrf
        @method('put')
        ...
        <div>
            ...
            <x-textarea id="summernote" class="block mt-1 w-full resize-vertical h-32" name="content" required>{{ $post->content }}</x-textarea>
        </div>
